...
namespace EtiSysAdmin.Server.Repositorios
{
    public class VentaRepositorio : GenericoRepositorio<Venta>, IVentaRepositorio
    {
        private readonly DbetiSySAdminContext _dbContext;
        public VentaRepositorio(DbetiSySAdminContext dbContext) : base(dbContext)
        {
