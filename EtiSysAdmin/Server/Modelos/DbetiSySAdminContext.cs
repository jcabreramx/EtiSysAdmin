...
public partial class DbetiSySAdminContext : DbContext
{
    public DbetiSySAdminContext()
    {
    }

    public DbetiSySAdminContext(DbContextOptions<DbetiSySAdminContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdPuesto).HasName("PK_Puesto");
        ...
        {
            entity.HasKey(e => e.IdPerfil).HasName("PK_Perfil");
